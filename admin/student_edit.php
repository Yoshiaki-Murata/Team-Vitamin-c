...
<body>
	<div class="l-wrapper">
		...
		<form action="student_edit_do.php" method="post">
			...
			<label>終了予定日</label>
			<input type="date" name="graduation_date" class="form-control mb-3"
				value="<?php echo h($student['graduation_date']); ?>">

			<!-- ログインID -->
			<label>ログインID</label>
			<input type="text" name="login_id" class="form-control mb-3"
			...
			<!-- 在籍状況 -->
			<label>在籍状況</label>
			<select name="status_id" class="form-control mb-4">
